...
export function BulkPasteModal({ categories, workspaceId, onClose, onImport }: Props) {
        ...
        {result ? (
          ...
          <>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-3 py-2 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-accent dark:bg-secondary dark:text-slate-100 font-mono text-sm resize-y"
            />
                  ...
                  <table className="w-full text-xs text-left">
                    <thead className="bg-muted border-b border-border sticky top-0">
                      <tr>
                        ...
                        <th className="p-2 font-medium text-muted-foreground">Tarih</th>
                        <th className="p-2 font-medium text-muted-foreground">Açıklama</th>
                        <th className="p-2 font-medium text-muted-foreground">Tutar</th>
                        <th className="p-2 font-medium text-muted-foreground">Tip</th>
                        <th className="p-2 font-medium text-muted-foreground">Kategori</th>
                      </tr>
                    </thead>
                    <tbody>
                      {parsedRows.map((row) => (
                        <tr key={row.lineNumber} className="border-b border-border last:border-0">
                          ...
                          {row.errors.length > 0 ? (
                            ...
                            <>
                              ...
                              <td className="p-2 align-top text-foreground dark:text-muted-foreground">
                                {formatTRY(row.amount as number)}
                              </td>
