                  ...
                  <table className="w-full text-xs text-left">
                    <thead className="bg-muted dark:bg-primary border-b border-border dark:border-border sticky top-0">
                      <tr>
                        ...
                        <th className="p-2 font-medium text-muted-foreground dark:text-muted-foreground">Güncel Değer</th>
                          ...
                          {row.errors.length > 0 ? (
                            ...
                            <>
                              ...
                              <td className="p-2 align-top text-foreground dark:text-muted-foreground">
                                {row.assetType || <span className="text-muted-foreground dark:text-muted-foreground">-</span>}
                              </td>
                              <td className="p-2 align-top text-foreground dark:text-muted-foreground">
