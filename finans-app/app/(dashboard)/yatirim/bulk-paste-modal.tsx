                  ...
                  <table className="w-full text-xs text-left">
                    <thead className="bg-muted border-b border-border sticky top-0">
                      <tr>
                        ...
                        <th className="p-2 font-medium text-muted-foreground">Sembol</th>
                        <th className="p-2 font-medium text-muted-foreground">Miktar</th>
                        <th className="p-2 font-medium text-muted-foreground">Ort. Maliyet</th>
                        <th className="p-2 font-medium text-muted-foreground">Güncel Fiyat</th>
                      </tr>
                    </thead>
                    <tbody>
                      {parsedRows.map((row) => (
                        <tr key={row.lineNumber} className="border-b border-border last:border-0">
                          ...
                          {row.errors.length > 0 ? (
                            ...
                            <>
                              ...
                              <td className="p-2 align-top text-foreground dark:text-muted-foreground">
                                {row.avgCost !== null ? formatCurrency(row.avgCost, row.currency) : <span className="text-muted-foreground">-</span>}
                              </td>
                              <td className="p-2 align-top text-foreground dark:text-muted-foreground">
                                {row.currentPrice !== null ? formatCurrency(row.currentPrice, row.currency) : <span className="text-muted-foreground">-</span>}
                              </td>
                            </>
                          )}
                        </tr>
