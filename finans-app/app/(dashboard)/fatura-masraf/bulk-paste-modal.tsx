                  ...
                  <table className="w-full text-xs text-left">
                    <thead className="bg-muted border-b border-border sticky top-0">
                      <tr>
                        ...
                        <th className="p-2 font-medium text-muted-foreground">Başlık</th>
                        <th className="p-2 font-medium text-muted-foreground">Tutar</th>
                        <th className="p-2 font-medium text-muted-foreground">Vade Tarihi</th>
                        <th className="p-2 font-medium text-muted-foreground">Tekrar</th>
                      </tr>
                    </thead>
                    <tbody>
                      {parsedRows.map((row) => (
